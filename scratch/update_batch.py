...
batch_items_fr = [
    ...
    },
    {
        ...
        "descriptions": {
            "badly damaged": [
                "🔴 Un réservoir de carburant en acier lourd complètement Eventré et rouillé, laissant échapper une boue noire huileuse.",
                "🔴 Cet énorme réservoir montre des parois métalliques rongées par l'oxydation calcaire marine.",
                "🔴 Une carcasse de citerne industrielle tordue et encroûtée d'algues épaisses de vase sombre."
            ],
            "damaged": [
    ...
    },
    {
        ...
        "descriptions": {
            ...
            "worn": [
                ...
                "🟡 Une hélice de cargo usagée perdue récemment, reposant à plat au fond de l'eau claire."
            ]
        },
...
def update_file(file_path, items):
    ...
    for item in items:
        ...
        # Remove if it exists in any rarity to avoid duplicates
    ...
    # Sort items by ID in each rarity
    for r in data.keys():
...
if __name__ == "__main__":
    ...
    update_file(JUNK_EN_PATH, batch_items_en)
    print("Batch 6 successfully updated!")
